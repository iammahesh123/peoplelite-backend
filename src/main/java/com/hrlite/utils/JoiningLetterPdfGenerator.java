...
@Component
@Slf4j
public class JoiningLetterPdfGenerator {
    ...
    public byte[] generate(String htmlContent, Map<String, String> variables) {
        try (ByteArrayOutputStream baos = new ByteArrayOutputStream()) {
            ...
            log.error("Error generating joining letter PDF", e);
            throw new RuntimeException("Failed to generate joining letter PDF", e);
        }
    }
